    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($data) {
                ...
                $result .= '<button type="submit" data-id="' . $data->id . '" class="btn-sm btn-danger mr-sm-2 mb-1 delete" title="course delete" ><i class="fa fa-trash" aria-hidden="true"></i></button>';
                return $result;
            })
