                            ...
                            <ul class="timeline">
                                ...
                                <li class="timeline-item">
                                    <div class="timeline-badge"><span class="bg-primary bg-lighten-4"
                                            ...
                                            title="Portfolio project work"><img class="avatar"
                                                src="{{ asset('college-assets/app-assets/img/portrait/small/avatar-s-15.png') }}"
                                ...
                                <li class="timeline-item">
                                    <div class="timeline-badge"><span class="bg-primary bg-lighten-4"
                                            data-toggle="tooltip" data-placement="right"
                                            title="Portfolio project work"><img class="avatar"
                                                src="{{ asset('college-assets/app-assets/img/portrait/small/avatar-s-16.png') }}"
                                                alt="avatar" width="40"></span></div>
                                    <div class="activity-list-text">
                                        ...
                                        <div class="notification-note">
                                            <div class="p-1 pl-2"><img
                                                    src="{{ asset('college-assets/app-assets/img/icons/sketch-mac-icon.png') }}"
                            ...
                            <ul class="timeline">
                                ...
                                <li class="timeline-item">
                                    <div class="timeline-badge"><span class="bg-primary bg-lighten-4"
                                            data-toggle="tooltip" data-placement="right"
                                            title="Portfolio project work"><img class="avatar"
                                                src="{{ asset('college-assets/app-assets/img/portrait/small/avatar-s-26.png') }}"
                                                alt="avatar" width="40"></span></div>
                                    <div class="activity-list-text">
                                        ...
                                        <div class="notification-note">
                                            <div class="p-1 pl-2"><img
                                                    src="{{ asset('college-assets/app-assets/img/icons/pdf.png') }}"
                                ...
                                <li class="timeline-item">
                                    <div class="timeline-badge"><span class="bg-primary bg-lighten-4"
                                            data-toggle="tooltip" data-placement="right"
                                            title="Portfolio project work"><img class="avatar"
                                                src="{{ asset('college-assets/app-assets/img/portrait/small/avatar-s-23.png') }}"
                                                alt="avatar" width="40"></span></div>
                                    <div class="activity-list-text">
