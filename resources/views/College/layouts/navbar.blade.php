         ...
         <div class="collapse navbar-collapse d-block" id="navbarSupportedContent">
            <ul class="navbar-nav">
               <li class="i18n-dropdown dropdown nav-item mr-2">
                  <!-- <a class="nav-link d-flex align-items-center dropdown-toggle dropdown-language" id="dropdown-flag" href="javascript:;" data-toggle="dropdown"><img class="langimg selected-flag" src="{{ asset('college-assets/app-assets/img/flags/us.png')}}" alt="flag"><span class="selected-language d-md-flex d-none">English</span></a> -->
                  <div class="dropdown-menu dropdown-menu-right text-left" aria-labelledby="dropdown-flag"><a class="dropdown-item" href="javascript:;" data-language="en"><img class="langimg mr-2" src="{{ asset('college-assets/app-assets/img/flags/us.png')}}" alt="flag"><span class="font-small-3">English</span></a><a class="dropdown-item" href="javascript:;" data-language="es"><img class="langimg mr-2" src="{{ asset('college-assets/app-assets/img/flags/es.png')}}" alt="flag"><span class="font-small-3">Spanish</span></a><a class="dropdown-item" href="javascript:;" data-language="pt"><img class="langimg mr-2" src="{{ asset('college-assets/app-assets/img/flags/pt.png')}}" alt="flag"><span class="font-small-3">Portuguese</span></a><a class="dropdown-item" href="javascript:;" data-language="de"><img class="langimg mr-2" src="{{ asset('college-assets/app-assets/img/flags/de.png')}}" alt="flag"><span class="font-small-3">German</span></a></div>
               </li>
                     ...
                     <li class="scrollable-container"><a class="d-flex justify-content-between" href="javascript:void(0)">
                           <div class="media d-flex align-items-center">
                              <div class="media-left">
                                 <div class="mr-3"><img class="avatar" src="{{ asset('college-assets/app-assets/img/portrait/small/avatar-s-20.png')}}" alt="avatar" height="45" width="45"></div>
                              </div>
                           ...
                           <div class="media d-flex align-items-center">
                              <div class="media-left">
                                 <div class="mr-3"><img class="avatar" src="{{ asset('college-assets/app-assets/img/portrait/small/avatar-s-11.png')}}" alt="avatar" height="45" width="45"></div>
                              </div>
                              <div class="media-body">
                           ...
                           <div class="media d-flex align-items-center py-0 pr-0">
                              <div class="media-left">
                                 <div class="mr-3"><img src="{{ asset('college-assets/app-assets/img/icons/sketch-mac-icon.png')}}" alt="avatar" height="45" width="45"></div>
                              </div>
                              <div class="media-body">
                        ...
                        <div class="d-flex justify-content-between cursor-pointer read-notification">
                           ...
                           <div class="media d-flex align-items-center">
                              <div class="media-left">
                                 <div class="mr-3"><img class="avatar" src="{{ asset('college-assets/app-assets/img/portrait/small/avatar-s-6.png')}}" alt="avatar" height="45" width="45"></div>
                              </div>
                              <div class="media-body">
                        ...
                        <div class="d-flex justify-content-between cursor-pointer read-notification">
                           ...
                           <div class="media d-flex align-items-center">
                              <div class="media-left">
                                 <div class="mr-3"><img class="avatar" src="{{ asset('college-assets/app-assets/img/portrait/small/avatar-s-7.png')}}" alt="avatar" height="45" width="45"></div>
                              </div>
                              <div class="media-body">
               ...
               <li i class="dropdown nav-item mr-1">
                  <a class="nav-link dropdown-toggle user-dropdown d-flex align-items-end" id="dropdownBasic2" href="javascript:;" data-toggle="dropdown">
                     <div class="user d-md-flex d-none mr-2">
                        <span class="text-right">{{Auth::guard('college')->user()->name}}</span>
                        <span class="text-right text-muted font-small-3">Available</span>
                     </div>
                     <img class="avatar" src="{{asset('/storage/college/'.Auth::guard('college')->user()->logo)}}" alt="avatar" height="35" width="35">
                  </a>
                ...
                <div class="d-flex align-items-center"><i class="ft-message-square mr-2"></i><span>Chat</span></div>
                     ...
                     <a class="dropdown-item" href="{{ route('college.logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
