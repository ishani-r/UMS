                            ...
                            <ul class="timeline">
                                ...
                                <li class="timeline-item">
                                    <div class="timeline-badge"><span class="bg-primary bg-lighten-4"
                                            ...
                                            title="Portfolio project work"><img class="avatar"
                                                src="{{ asset('student-assets/app-assets/img/portrait/small/avatar-s-15.png') }}"
                                    ...
                                    <div class="activity-list-text">
                                        ...
                                        <div class="notification-note">
                                            <div class="p-1 pl-2"><span
                                                    class="text-bold-500">Snooze</span></div>
                                        </div>
                                    </div>
                                </li>
                                <li class="timeline-item">
                                    <div class="timeline-badge"><span class="bg-primary bg-lighten-4"
                                            data-toggle="tooltip" data-placement="right"
                                            title="Portfolio project work"><img class="avatar"
                                                src="{{ asset('student-assets/app-assets/img/portrait/small/avatar-s-16.png') }}"
                                                alt="avatar" width="40"></span></div>
                                    <div class="activity-list-text">
                                        ...
                                        <div class="notification-note">
                                            <div class="p-1 pl-2"><img
                                                    src="{{ asset('student-assets/app-assets/img/icons/sketch-mac-icon.png') }}"
                                ...
                                <li class="timeline-item">
                                    ...
                                    <div class="activity-list-text">
                                        ...
                                        <div class="notification-note">
                                            <div class="p-1 pl-2"><span
                                                    class="text-bold-500">Listen</span></div>
                                        </div>
                                    </div>
                                </li>
                                <li class="timeline-item">
                            ...
                            <ul class="timeline">
                                ...
                                <li class="timeline-item">
                                    <div class="timeline-badge"><span class="bg-primary bg-lighten-4"
                                            data-toggle="tooltip" data-placement="right"
                                            title="Portfolio project work"><img class="avatar"
                                                src="{{ asset('student-assets/app-assets/img/portrait/small/avatar-s-26.png') }}"
                                                alt="avatar" width="40"></span></div>
                                    <div class="activity-list-text">
                                        ...
                                        <div class="notification-note">
                                            <div class="p-1 pl-2"><img
                                                    src="{{ asset('student-assets/app-assets/img/icons/pdf.png') }}"
                                ...
                                <li class="timeline-item">
                                    ...
                                    <div class="activity-list-text">
                                        ...
                                        <div class="notification-note">
                                            <div class="p-1 pl-2"><span
                                                    class="text-bold-500">Important</span></div>
                                        </div>
                                    </div>
                                </li>
                                <li class="timeline-item">
                                    <div class="timeline-badge"><span class="bg-primary bg-lighten-4"
                                            data-toggle="tooltip" data-placement="right"
                                            title="Portfolio project work"><img class="avatar"
                                                src="{{ asset('student-assets/app-assets/img/portrait/small/avatar-s-23.png') }}"
                                                alt="avatar" width="40"></span></div>
                                    <div class="activity-list-text">
