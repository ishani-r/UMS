      ...
      <div class="collapse navbar-collapse d-block" id="navbarSupportedContent">
        <ul class="navbar-nav">
          <li class="i18n-dropdown dropdown nav-item mr-2">
            ...
            <div class="dropdown-menu dropdown-menu-right text-left" aria-labelledby="dropdown-flag"><a class="dropdown-item" href="javascript:;" data-language="en"><img class="langimg mr-2" src="{{ asset('university-assets/app-assets/img/flags/us.png')}}" alt="flag"><span class="font-small-3">English</span></a><a class="dropdown-item" href="javascript:;" data-language="es"><img class="langimg mr-2" src="{{ asset('university-assets/app-assets/img/flags/es.png')}}" alt="flag"><span class="font-small-3">Spanish</span></a><a class="dropdown-item" href="javascript:;" data-language="pt"><img class="langimg mr-2" src="{{ asset('university-assets/app-assets/img/flags/pt.png')}}" alt="flag"><span class="font-small-3">Portuguese</span></a><a class="dropdown-item" href="javascript:;" data-language="de"><img class="langimg mr-2" src="{{ asset('university-assets/app-assets/img/flags/de.png')}}" alt="flag"><span class="font-small-3">German</span></a></div>
          </li>
              ...
              <li class="scrollable-container"><a class="d-flex justify-content-between" href="javascript:void(0)">
                  <div class="media d-flex align-items-center">
                    <div class="media-left">
                      <div class="mr-3"><img class="avatar" src="{{ asset('university-assets/app-assets/img/portrait/small/avatar-s-20.png')}}" alt="avatar" height="45" width="45"></div>
                    </div>
                  ...
                  <div class="media d-flex align-items-center">
                    <div class="media-left">
                      <div class="mr-3"><img class="avatar" src="{{ asset('university-assets/app-assets/img/portrait/small/avatar-s-11.png')}}" alt="avatar" height="45" width="45"></div>
                    </div>
                    <div class="media-body">
                  ...
                  <div class="media d-flex align-items-center py-0 pr-0">
                    <div class="media-left">
                      <div class="mr-3"><img src="{{ asset('university-assets/app-assets/img/icons/sketch-mac-icon.png')}}" alt="avatar" height="45" width="45"></div>
                    </div>
                    <div class="media-body">
                ...
                <div class="d-flex justify-content-between cursor-pointer read-notification">
                  ...
                  <div class="media d-flex align-items-center">
                    <div class="media-left">
                      <div class="mr-3"><img class="avatar" src="{{ asset('university-assets/app-assets/img/portrait/small/avatar-s-6.png')}}" alt="avatar" height="45" width="45"></div>
                    </div>
                    <div class="media-body">
                ...
                <div class="d-flex justify-content-between cursor-pointer read-notification">
                  ...
                  <div class="media d-flex align-items-center">
                    <div class="media-left">
                      <div class="mr-3"><img class="avatar" src="{{ asset('university-assets/app-assets/img/portrait/small/avatar-s-7.png')}}" alt="avatar" height="45" width="45"></div>
                    </div>
                    <div class="media-body">
          ...
          <li i class="dropdown nav-item mr-1">
            ...
            <div class="dropdown-menu text-left dropdown-menu-right m-0 pb-0" aria-labelledby="dropdownBasic2">
              ...
              <a class="dropdown-item" href="auth-login.html" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
